...
<body>
    <section id="Projects"
        ...
        <div class="relative m-10 overflow-hidden rounded-lg bg-white shadow-md " style="height: 74%;width:78%;">
            <a href="#">
                <img class=" rounded-t-lg object-cover" style="height: 54%;"
            ...
            <div class="mt-3 px-3 pb-5">
                ...
                <div class="flex items-center justify-between">
                    <p class="flex flex-col">
                        <span class="text-base font-bold text-slate-900">MAD249</span>
                        <span class="text-sm text-slate-900 line-through">MAD299</span>
                    </p>
                    <a href="#" class="inline-flex items-center justify-center rounded-md  px-5 py-2.5 text-center text-sm font-medium text-black hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-blue-300 w-1/2" style="background: #27a776;" data-bs-toggle="modal" data-bs-target="#exampleModal">
...
{{-------------------------------------------------}}
        ...
        <div class="relative m-10 overflow-hidden rounded-lg bg-white shadow-md " style="height: 74%;width:78%;">
            <a href="#">
                <img class=" rounded-t-lg " style="height: 54%;width:auto;"
                    src="https://images.unsplash.com/flagged/photo-1556637640-2c80d3201be8?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8M3x8c25lYWtlcnxlbnwwfHwwfHw%3D&auto=format&fit=crop&w=500&q=60"
                    alt="product image" />
            </a>
            <span
            ...
            <div class="mt-3 px-3 pb-5">
                ...
                <div class="flex items-center justify-between">
                    ...
                    <a href="#" class="inline-flex items-center justify-center rounded-md  px-5 py-2.5 text-center text-sm font-medium text-black hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-blue-300 w-1/2" style="background: #27a776;">
                        <img src="svg_icon/barcode_code_icon_194645.ico" alt="Shopping" class="mr-2 h-4 w-6">
                        <span class="text-base">Acheter</span>
                    </a>
                </div>
